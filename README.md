...
graph BT
    ...
    JPMCNode -->|then| APICreationNode["<div style='font-size:75%; color:#848484; text-align:center;'>2021-10</div><div style='font-size:75%; color:#848484; text-align:center;'><b>Level: L2</b></div>Created team standards for REST APIs for securities exchange<br/><b>Impact: </b>Team-wide<div style='font-size:75%; color:#848484; text-align:center;'>#API #REST #Standards<br/></div>"]
    APICreationNode -->|then| Credential1["<div style='font-size:75%; color:#848484; text-align:center;'>2022</div><div style='font-size:75%; color:#848484; text-align:center;'><b>Level: L2</b></div>Earned Certified AWS Developer - Associate certificate<br/><div style='font-size:75%; color:#848484; text-align:center;'>#AWS</div>"]
    ...
    class PreStudentNode,ContractorNode,A,JPMCNode,APICreationNode,Credential1,USAA2022Node,Creation1,Chat,Creation2,B,C,D,E,F,G,Chat2,CreationPromptLib,CreationDesign,CommitteeNode,MoveL3,MoveTechLead rounded;
